...
async def rsvp_user_create(user_id: str, event_id: int) -> bool:
...
async def rsvp_user_delete(user_id: str, event_id: int):
...
async def rsvp_user_get(user_id: str) -> EventIDList:
